// LCD pin definitions (P1.20-P1.23 for data, P1.17-RS, P1.18-RW, P1.19-E)
...
void lcd_data(unsigned char d)
{
    // Send higher nibble
    IOCLR1 = LCD_D;                    
    IOSET1 = (d & 0xf0) << 16;         // Put higher nibble on data pins
    ...
    // Send lower nibble
    IOCLR1 = LCD_D;                    
    IOSET1 = (d & 0x0f) << 20;         // Put lower nibble on data pins
    IOSET1 = RS;                        
    IOCLR1 = RW;                        
    IOSET1 = E;                         
    delay_ms(2);                        
